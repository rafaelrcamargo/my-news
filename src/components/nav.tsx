...
export const NAV_CLASSNAME =
  "fixed m-4 z-999 h-16 shadow-xl dark:shadow-neutral-950/30 border rounded-full flex center border-neutral-200 bg-neutral-100/10 px-4 dark:border-neutral-500/10 dark:bg-neutral-800/10 backdrop-blur-sm backdrop-saturate-150"
...
const Nav: FC<{ dispatch: Dispatch<"LIKE" | "DISLIKE">; theme: Theme }> = ({
  ...
  return (
    <nav
      className={cn(NAV_CLASSNAME, "bottom-0 left-1/2 -translate-x-1/2 px-6")}
    >
