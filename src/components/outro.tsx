...
export const Outro = () => {
  const { reward } = useReward("reload", "confetti")
  ...
  return (
    <div
      id="reload"
      className="center absolute left-1/2 top-1/2 w-[68vw] max-w-sm -translate-x-1/2 -translate-y-1/2 animate-fade-in flex-col gap-6 text-center opacity-0">
      <a
        onClick={reload}
