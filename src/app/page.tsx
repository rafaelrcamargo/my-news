...
const CLASSNAME =
	// Responsive: w-[60vw] max-w-xl max-h-[48rem] aspect-card
...
type Props = typeof NEWS.articles[number] & {
...
const Placeholder: FC<Pick<Props, "title"> & { i: number }> = ({
	title,
	i,
}) => {
	return (
...
const Deck = () => {
	...
	return (
		<motion.div className="center h-screen w-full relative overflow-hidden">
			<AnimatePresence>
